...
import com.wangbo.user.pojo.User;
import com.wangbo.user.service.UserService;
...
public class UserController {
	...
	public Result login(@RequestBody User user) {
		...
		// 登录成功后的操作
		String token = jwtUtil.createJWT(user.getId(), user.getMobile(), "com/wangbo/user");
		Map<String, Object> map = new HashMap<>();
		map.put("token", token);
		map.put("roles", "com/wangbo/user");
